...
export default function FloatingWhatsApp() {
  ...
  const handleClick = () => {
    ...
    window.open("https://wa.me/5521964648749?text=Olá,%20gostaria%20de%20fazer%20uma%20cotação!", "_blank", "noopener,noreferrer");
  };
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          {/* Pulsing ring effect */}
          <span className="absolute inset-0 rounded-full animate-smooth-pulse"></span>
        </motion.button>
      )}
    </AnimatePresence>
  );
